...
<form class="max-w-md mx-auto mt-48">
          <h1 className='font-bold text-2xl mb-7 text-gray-700'> Please Register</h1>
<div class="grid md:grid-cols-2 md:gap-6">
  ...
  <button type="submit" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 mb-9">Register</button>
</form>

<p className='text-center text-gray-700 mb-14'>Already have an account ? Please <Link to="/login" className='text-gray-800 text-lg'>Log In</Link></p>
